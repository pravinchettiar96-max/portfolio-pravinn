...
export default function Institutions() {
  const institutions = [
    ...
    },
    {
      ...
      type: "B.Voc in AI & ML and Data Science",
      icon: "🎓",
      image: "/degree.png",
      color: "from-purple-500 to-pink-500",
      website: "https://nexcoreinstitute.org/",
      description: "Leading technical institute focused on innovation, research, and industry-ready skills in AI, Machine Learning and Data Science",
      highlights: [
        "Pursuing B.Voc in Artificial Intelligence & Machine Learning and Data Science",
                ...
                <div className="flex flex-col lg:flex-row gap-6 items-center">
                  ...
                  <div className="flex-1 text-center lg:text-left">
                    ...
                    <a 
                      ...
                      className="inline-flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-full font-semibold text-sm hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-orange-500/50 border-0 outline-none"
                      style={{background: 'linear-gradient(to right, rgb(249, 115, 22), rgb(239, 68, 68))'}}
                    >
